<?php
// $title and $category are passed from controller
$pageTitle = $title ?? 'Modifier la catégorie';
$currentCategory = $category ?? []; // Category data from controller
...
<?php if (empty($currentCategory)): ?>
    ...
    <p><a href="index.php?url=productcategories/index" class="button button-info">Retour à la liste des catégories</a></p>
<?php else: ?>
    ...
    <form action="index.php?url=productcategories/update/<?php echo htmlspecialchars($currentCategory['id']); ?>" method="POST">
        <fieldset>
