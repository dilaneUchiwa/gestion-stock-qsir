<?php
$pageTitle = $title ?? 'Modifier la catégorie de fournisseurs';
...
<?php if (empty($currentCategory)): ?>
    ...
    <p><a href="index.php?url=suppliercategories/index" class="button button-info">Retour à la liste des catégories</a></p>
<?php else: ?>
    ...
    <form action="index.php?url=suppliercategories/update/<?php echo htmlspecialchars($currentCategory['id']); ?>" method="POST">
        <fieldset>
            <legend>Détails de la catégorie de fournisseurs</legend>
        ...
        <div class="form-group mt-3">
            ...
            <a href="index.php?url=suppliercategories/index" class="button button-info">Annuler</a>
        </div>
    </form>
<?php endif; ?>
