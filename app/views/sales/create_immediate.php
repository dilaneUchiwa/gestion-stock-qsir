...
// $title = 'New Sale (Immediate Payment)';
?>

<h2>New Sale (Immediate Payment)</h2>
...
<form action="index.php?url=sale/store" method="POST" id="saleForm">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <small>If not selected, enter Occasional Client Name below.</small>
        </div>
        <div class="form-group">
            ...
            <small>Required if no Registered Client is selected.</small>
        </div>
        <div class="form-group">
    ...
    <div class="form-group" style="margin-top: 20px;">
        <button type="submit" class="button">Record Sale (Paid)</button>
